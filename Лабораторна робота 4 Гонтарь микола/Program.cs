...
namespace OOP_LB4_1_3_task
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Human human = new Human("Pogik", "Hromiak", "Male", 28);
            Debug.WriteLine($"This is class {human.GetType().Name}");
            human.Info();

            Employee employee = new Employee("Mikola", "Gontar", "Male", 18, "Director", 18785);
            ...
            Hero hero = new Hero("Boss", "Ship", 1200, "Sword", 15);
            hero.ShowInfo();

            Enemy enemy = new Enemy("Elf", "Mountain", 20000, "Fire", 50);
            enemy.ShowInfo();
